...
function App() {
    var _this = this;
    var _a = useState({ province: '', city: '' }), location = _a[0], setLocation = _a[1];
    var _b = useState([]), provinces = _b[0], setProvinces = _b[1];
    // Memoize the fetch function to prevent unnecessary recreations
    var fetchProvinces = useMemo(function () { return function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (<ProvinceCitySelect value={location} onChange={setLocation} theme="light" size="md" selectorType="select" variant="outlined" isRequired labels={{
            province: 'استان',
            city: 'شهر',
        }}/>);
}
